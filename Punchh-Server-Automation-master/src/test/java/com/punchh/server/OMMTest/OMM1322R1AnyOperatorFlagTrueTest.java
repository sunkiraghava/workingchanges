...
public class OMM1322R1AnyOperatorFlagTrueTest {

	static Logger logger = LogManager.getLogger(OMM1322R1AnyOperatorFlagTrueTest.class);
	...
	// BEFORE METHOD → Load JSON test data
		...
		public void setUp(Method method) throws Exception {
			...
			logger.info(sTCName + " test-data loaded → " + dataSet);
	...
	// Enable Flag- enable_decoupled_redemption_engine from the DB
		private void EnableDecoupledRedemptionAndEnableReturnQCItemsFlag() throws Exception {
			...
			logger.info("enable_decoupled_redemption_engine value is updated to true");
			...
			logger.info("return_qualifying_menu_items_to_pos value is updated to true");
		}
		...
		@Test(groups = {"OMM", "Regression"},
				description = "SQ-T7456 | R1 | Base & Modifiers | Verify that an offer qualifies when at least one condition is met using the 'OR' operator")
		@Owner(name = "Hitesh Popli")
		public void T7456_R1_Flag_True_verify_single_item_qualifier_AnyOperator_BaseAndModifiers() throws Exception {
			EnableDecoupledRedemptionAndEnableReturnQCItemsFlag();
			...
			logger.info("== Creating Line Item Selectors (LIS) ==");
			...
			// *******************************************************************
			logger.info("== Creating Qualification Criteria (QC) ==");
			...
			// *******************************************************************
			logger.info("== Creating Redeemable ==");
			...
			// STEP 5: User Signup
			// *******************************************************************
			logger.info("== Mobile API v2: User Signup ==");
		...
		@Test(groups = {"OMM", "Regression"},
				description = "SQ-T7457 | R1 | Base & Modifiers | Verify offer does not qualify when no conditions are met with 'OR' operator")
		@Owner(name = "Hitesh Popli")
		public void T7457_R1_Flag_True_verify_offer_does_not_qualify_for_item_qualifier_AnyOperator_BaseAndModifiers() throws Exception {
			...
			Assert.assertNotNull(dbRedeemableId, "DB Redeemable ID should not be null");
			logger.info("DB Redeemable ID: " + dbRedeemableId);
			...
			logger.info("Validation complete — QC failure scenario passed successfully.");
		}

		@Test(groups = {"OMM", "Regression"},
				description = "SQ-T7458 | R1 | Base & Modifiers | Verify offer qualifies when two condition are met with 'OR' operator")
		@Owner(name = "Hitesh Popli")
		public void T7458_R1_Flag_True_verify_offer_two_condition_match_for_item_qualifier_AnyOperator_BaseAndModifiers() throws Exception {
		...
		@Test(groups = {"OMM", "Regression"},
				description = "SQ-T7459 | R1 | Base & Modifiers | Verify that an offer qualifies when at least one condition is met using the 'AND' operator")
		@Owner(name = "Hitesh Popli")
		public void T7459_R1_Flag_True_verify_single_item_qualifier_And_Operator_BaseAndModifiers() throws Exception {
		...
		@Test(groups = {"OMM", "Regression"},
				description = "SQ-T7460 | R1 | Base & Modifiers | Verify offer does not qualify when no conditions are met with 'AND' operator")
		@Owner(name = "Hitesh Popli")
		public void T7460_R1_Flag_True_verify_offer_does_not_qualify_for_item_qualifier_AllOperator_BaseAndModifiers() throws Exception {
		...
		@Test(groups = {"OMM", "Regression"},
				description = "SQ-T7461 | R1 | Base & Modifiers | Verify offer qualifies when two condition are met with 'AND' operator")
		@Owner(name = "Hitesh Popli")
		public void T7461_R1_Flag_True_verify_offer_two_condition_match_for_item_qualifier_AndOperator_BaseAndModifiers() throws Exception {
		...
		@Test(groups = {"OMM", "Regression"},
				description = "SQ-T7450 | R1 | Base Only| Verify that an offer qualifies when at least one condition is met using the 'OR' operator")
		@Owner(name = "Hitesh Popli")
		public void T7450_R1_Flag_True_verify_single_item_qualifier_AnyOperator_Base() throws Exception {
		...
		@Test(groups = {"OMM", "Regression"},
				description = "SQ-T7451 | R1 |Only Base | Verify offer does not qualify when no conditions are met with 'OR' operator")
		@Owner(name = "Hitesh Popli")
		public void T7451_R1_Flag_True_verify_offer_does_not_qualify_for_item_qualifier_AnyOperator_Base() throws Exception {
		...
		@Test(groups = {"OMM", "Regression"},
				description = "SQ-T7452 | R1 | Base | Verify offer qualifies when two condition are met with 'OR' operator")
		@Owner(name = "Hitesh Popli")
		public void T7452_R1_Flag_True_verify_offer_two_condition_match_for_item_qualifier_AnyOperator_BaseOnly() throws Exception {
		...
		@Test(groups = {"OMM", "Regression"},
				description = "SQ-T7453 | R1 | Modifier Only| Verify that an offer qualifies when at least one condition is met using the 'OR' operator")
		@Owner(name = "Hitesh Popli")
		public void T7453_R1_Flag_True_verify_single_item_qualifier_AnyOperator_Modifier() throws Exception {
		...
		@Test(groups = {"OMM", "Regression"},
				description = "SQ-T7454 | R1 | Only Modifier | Verify offer does not qualify when no conditions are met with 'OR' operator")
		@Owner(name = "Hitesh Popli")
		public void T7454_R1_Flag_True_verify_offer_does_not_qualify_for_item_qualifier_AnyOperator_Modifier() throws Exception {
		...
		@Test(groups = {"OMM", "Regression"},
				description = "SQ-T7455 | R1 | Only Modifier | Verify offer qualifies when two condition are met with 'OR' operator")
		@Owner(name = "Hitesh Popli")
		public void T7455_R1_Flag_True_verify_offer_two_condition_match_for_item_qualifier_AnyOperator_Modifier_only() throws Exception {

...
public class ValidationInBatchProcessRedemptionOMM_T108 {
	static Logger logger = LogManager.getLogger(ValidationInBatchProcessRedemptionOMM_T108.class);
	...
	@Test(description = "OMM-T108 (1.0) STEP -1 Verify cases for Item Qualifiers expression \"Net Quantity Greater Than Or Equal To\"", priority = 0)
	public void validateTwoRewards108() {
		...
		Response batchRedemptionProcessResponseUser1 = pageObj.endpoints()
				.processBatchRedemptionOfBasketPOSAPI108(dataSet.get("locationKey"), userID, "25", "5", "5", "5", "10");
	...
	@Test(description = "OMM-T108 (1.0) STEP -2 Verify cases for Item Qualifiers expression \"Net Quantity Greater Than Or Equal To\"", priority = 1)
	public void validateTwoRewards108_1() {
		double expRedeemption1DiscountAmt = Double.parseDouble(dataSet.get("expRedeemptionOneDiscountAmount1"));
		...
		Response batchRedemptionProcessResponseUser1 = pageObj.endpoints()
				.processBatchRedemptionOfBasket107(dataSet.get("locationKey"), userID, "13", "3", "10");
	...
	@Test(description = "OMM-T108 (1.0) STEP -3 Verify cases for Item Qualifiers expression \"Net Quantity Greater Than Or Equal To\" with Global Stacking -> On and Global Reusability -> On", priority = 2)
	public void validateThreeRewardsPercentageDiscount108() {
		double expRedeemption1DiscountAmt = Double.parseDouble(dataSet.get("expRedeemptionOneDiscountAmount1"));
		...
		Response batchRedemptionProcessResponseUser1 = pageObj.endpoints()
				.processBatchRedemptionOfBasket108(dataSet.get("locationKey"), userID, "20", "10", "10");
	...
	@Test(description = "OMM-T108 (1.0) STEP -4 Verify cases for Item Qualifiers expression \"Net Quantity Greater Than Or Equal To\" with Global Stacking -> Off and Global Reusability -> On", priority = 3)
	public void validateThreeRewardsPercentageDiscount108_1() {
		double expRedeemption1DiscountAmt = Double.parseDouble(dataSet.get("expRedeemptionOneDiscountAmount1"));
		...
		Response batchRedemptionProcessResponseUser1 = pageObj.endpoints()
				.processBatchRedemptionOfBasketPOSAPI108_1(dataSet.get("locationKey"), userID, "30", "10", "10", "10");
	...
	@Test(description = "OMM-T108 (1.0) STEP -5 Verify cases for Item Qualifiers expression \"Net Quantity Greater Than Or Equal To\" with Global Stacking -> Off and Global Reusability -> Off", priority = 4)
	public void validateThreeRewardsPercentageDiscount108_2() {
	...
	@Test(description = "OMM-T108 (1.0) STEP -6 Verify cases for Item Qualifiers expression \"Net Quantity Greater Than Or Equal To\"with Global Stacking -> On and Global Reusability -> Off", priority = 5)
	public void validateThreeRewardsPercentageDiscount108_3() {

...
public class ValidationInBatchRedemptionProcessOMM_T145 {
	static Logger logger = LogManager.getLogger(ValidationInBatchRedemptionProcessOMM_T145.class);
	...
	@Test(description = "SQ-T3446 Verify cases for Item Qualifiers expression 'Net Quantity Greater Than Or Equal To'", priority = 0)
	@Owner(name = "Ashwini Shetty")
	public void verify145_1() throws Exception {
		...
		// ===================== Create LIS =====================
		String lisName = "AutoSelect_LIS_T145_" + Utilities.getTimestamp();
		...
		// ===================== Create LIS 2 =====================
		String lisName2 = "AutoSelect_LIS_2_T145_" + Utilities.getTimestamp();
		...
		// =====================️ Create QC =====================
		String qcname = "AutoSelect_QC_T145_" + Utilities.getTimestamp();
		String qcPayload = apipayloadObj.qualificationCriteriaBuilder().setName(qcname)
				...
				.addItemQualifier("net_quantity_greater_than_or_equal_to",lisExternalID2, 2.0, 0).build();
		...
		// ===================== Create Redeemable =====================
		String redeemableName = "AutoRedeemable_T145_"
		...
		// =====================️ Create QC 2 =====================
		String qcname2 = "AutoSelect_QC2_T145_" + Utilities.getTimestamp();
		...
		// ===================== Create Redeemable 2 =====================
		String redeemableName2 = "AutoRedeemable_2_T145_"+ Utilities.getTimestamp();
		...
		addDetails.accept("Pizza2", new String[] { "Pizza2", "4", "10", "M", "10", "888", "2", "2001" });

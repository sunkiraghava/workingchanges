...
public class ValidationInBatchRedemptionProcessOMM_T148 {
	static Logger logger = LogManager.getLogger(ValidationInBatchRedemptionProcessOMM_T148.class);
	...
	@Test(description = "SQ-T3449 :Verify cases for Item Qualifiers expression 'Net Quantity Equal To'")
	@Owner(name = "Ashwini Shetty")
	public void verify148() throws Exception {
		...
		// ===================== Create LIS =====================
		String lisName = "AutoSelect_LIS_T148_" + Utilities.getTimestamp();
		...
		// ===================== Create LIS =====================
		String lisName2 = "AutoSelect_LIS_T148_" + Utilities.getTimestamp();
		...
		// =====================️ Create QC =====================
		String qcname = "AutoSelect_QC_T148_" + Utilities.getTimestamp();
		String qcPayload = apipayloadObj.qualificationCriteriaBuilder().setName(qcname)
				...
				.addItemQualifier("net_quantity_equal_to",lisExternalID2, 2.0, 0).build();
		...
		// ===================== Create Redeemable =====================
		String redeemableName = "AutoRedeemable_T148_"
		...
		Response sendRewardResponse1 = pageObj.endpoints().sendMessageToUser(userID, dataSet.get("apiKey"), "",
				dbRedeemableId, "", "");
		utils.logit("Send reward API response: " + sendRewardResponse1.asPrettyString());
		Assert.assertEquals(sendRewardResponse1.getStatusCode(), ApiConstants.HTTP_STATUS_CREATED, "Send reward API failed");
		
		
				
		// =====================️ Create QC 2 =====================
		String qcname2 = "AutoSelect_QC2_T148_" + Utilities.getTimestamp();
		...
		// ===================== Create Redeemable 2 =====================
		String redeemableName2 = "AutoRedeemable_2_T148_"+ Utilities.getTimestamp();
		...
		addDetails.accept("Coffee1", new String[] { "Coffee1", "2", "10", "M", "10", "888", "2", "2001" });

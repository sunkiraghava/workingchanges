...
public class ValidationInBatchRedemptionProcessOMM_T198 {
	static Logger logger = LogManager.getLogger(ValidationInBatchRedemptionProcessOMM_T198.class);
	...
	@Test
	public void verify198_1() throws InterruptedException {
		...
		Response batchRedemptionProcessResponseUser1 = pageObj.endpoints()
				.processBatchRedemptionOfBasketPOSAPI(dataSet.get("locationKey"), userID, "", "21", "10", "7", "4");
	...
	public void verify198_2() {
		...
		Response batchRedemptionProcessResponseUser1 = pageObj.endpoints()
				.processBatchRedemptionOfBasketPOSAPI198(dataSet.get("locationKey"), userID, "21", "10", "7", "4");
	...
	public void verify198_3() {
		...
		Response batchRedemptionProcessResponseUser1 = pageObj.endpoints()
				.processBatchRedemptionOfBasketPOSAPI198(dataSet.get("locationKey"), userID, "16", "10", "4", "2");

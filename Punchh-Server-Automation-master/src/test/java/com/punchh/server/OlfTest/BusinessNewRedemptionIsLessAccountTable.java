...
public class BusinessNewRedemptionIsLessAccountTable {
	private static Logger logger = LogManager.getLogger(BusinessNewRedemptionIsLessAccountTable.class);
	...
	@Test(description = "Verify user details in accounts table for user having less points than the new redemption mark", priority = 0)
	public void T1938_BusinessNewRedemptionIsLessAccountTable() throws Exception {

...
public class OLF398_UserCase7Test {
	private static Logger logger = LogManager.getLogger(OLF398_UserCase7Test.class);
...
//	Author :- Hardik Bhardwaj
	...
	@Test(description = "OLF-T2151 [New ML redemption mark is less than old] Verify point balance in iframe for users when business configuration has membership level Redemption Mark configured [User case 7]")
	public void T2151_VerifyPointBalanceinIframe() throws Exception {
		...
		Assert.assertEquals(checkinResponse1.getStatusCode(), 200, "Status code 200 did not match with POS Checkin ");
		...
		Assert.assertEquals(Integer.parseInt(iFrameActualpoints), actualPoints,
	...
	@Test(description = "OLF-T2152 [New ML redemption mark is less than old] Verify user's print timeline when business configuration has membership level Redemption Mark configured [user case 7]")
	public void T2152_VerifyPrintTimeLine() throws Exception {
		// login to instance -> here instance is https://divya.punchh.io
		pageObj.instanceDashboardPage().navigateToPunchhInstance(baseUrl);
		pageObj.instanceDashboardPage().loginToInstance();
		pageObj.instanceDashboardPage().selectBusiness(dataSet.get("slug"));
	...
	@Test(description = "OLF-T2153 [New ML redemption mark is less than old] Verify user's timeline / pie chart when business configuration has membership level Redemption Mark configured [user case 7]")
	public void T2153_VerifyTimeLine() throws Exception {
		// login to instance -> here instance is https://divya.punchh.io
		pageObj.instanceDashboardPage().navigateToPunchhInstance(baseUrl);
		pageObj.instanceDashboardPage().loginToInstance();
		pageObj.instanceDashboardPage().selectBusiness(dataSet.get("slug"));
	...
	@Test(description = "OLF-T2154 [New ML redemption mark is less than old] Verify user's account history when business configuration has membership level Redemption Mark configured [user case 7]")
	public void T2154_VerifyAccoutHistory() throws Exception {
		// login to instance -> here instance is https://divya.punchh.io
		pageObj.instanceDashboardPage().navigateToPunchhInstance(baseUrl);
		pageObj.instanceDashboardPage().loginToInstance();
		pageObj.instanceDashboardPage().selectBusiness(dataSet.get("slug"));
	...
	@Test(description = "OLF-T2155 [New ML redemption mark is less than old] Verify user balance in different secure API's when business configuration has membership level Redemption Mark configured [user case 7]")
	public void T2155_VerifySecureApi() throws Exception {
		// login to instance -> here instance is https://divya.punchh.io
		pageObj.instanceDashboardPage().navigateToPunchhInstance(baseUrl);
		pageObj.instanceDashboardPage().loginToInstance();
		pageObj.instanceDashboardPage().selectBusiness(dataSet.get("slug"));
		...
		Assert.assertEquals(totalDebits, points_spent, "total debit for api v1 mobile users balance is not matching");
		Assert.assertEquals(bankedRewards, actualPoints,
		...
		Assert.assertEquals(netBalance, actualPoints, "net Balance for api v1 mobile users balance is not matching");
		Assert.assertEquals(netDebits, points_spent, "net Debits for api v1 mobile users balance is not matching");
		...
		Assert.assertEquals(pointsBalance1, actualPoints, "points balance for api v1 mobile balance is not matching");
		Assert.assertEquals(totalCredits1, points_earned, "total cerdit for api v1 mobile balance is not matching");
		Assert.assertEquals(totalDebits1, points_spent, "total debit for api v1 mobile balance is not matching");
		Assert.assertEquals(bankedRewards1, actualPoints, "banked Rewards for api v1 mobile balance is not matching");
		...
		Assert.assertEquals(netBalance1, actualPoints, "net Balance for api v1 mobile balance is not matching");
		Assert.assertEquals(netDebits1, points_spent, "net Debits for api v1 mobile balance is not matching");
		...
		utils.logPass("points balance, banked rewards and net balance for api v1 mobile balance is matching i.e "
						+ actualPoints);
		logger.info(
				"Total Debits, total cerdit and net Debits for api v1 mobile balance is matching i.e. " + points_spent);
		utils.logPass(
				"Total Debits, total cerdit and net Debits for api v1 mobile balance is matching i.e. " + points_spent);
		...
		Assert.assertEquals(pointsEarnedApiFetchCheckin, points_earned,
				"points earned is not equal to " + actualPoints);
		logger.info("Verified that points earned is not equal to " + points_earned + " for Secure Api Fetch Checkin");
		utils.logPass("Verified that points earned is not equal to " + points_earned + " for Secure Api Fetch Checkin");
		...
		Assert.assertEquals(points_spentApiFetchCheckinTotal, points_spent,
				"points_spent is not equal to " + actualPoints);
		logger.info("Verified that points_spent is not equal to " + points_spent + " for Secure Api Fetch Checkin");
		utils.logPass("Verified that points_spent is not equal to " + points_spent + " for Secure Api Fetch Checkin");
		...
		Assert.assertEquals(points_availableApiFetchCheckinTotal, actualPoints,
				"points_spent is not equal to " + actualPoints);
		logger.info("Verified that points_available is not equal to " + actualPoints + " for Secure Api Fetch Checkin");
		utils.logPass(
				"Verified that points_available is not equal to " + actualPoints + " for Secure Api Fetch Checkin");
	...
	@Test(description = "OLF-T2156 [New ML redemption mark is less than old] Verify user balance in different API2 API's when business configuration has membership level Redemption Mark configured [user case 7]")
	public void T2156_VerifyMobileApi() throws Exception {
		// login to instance -> here instance is https://divya.punchh.io
		pageObj.instanceDashboardPage().navigateToPunchhInstance(baseUrl);
		pageObj.instanceDashboardPage().loginToInstance();
		pageObj.instanceDashboardPage().selectBusiness(dataSet.get("slug"));
	...
	@Test(description = "OLF-T2157 [New ML redemption mark is less than old] Verify user balance in different V1 API's when business configuration has membership level Redemption Mark configured [user case 7]")
	public void T2157_VerifyV1Api() throws Exception {
		// login to instance -> here instance is https://divya.punchh.io
		pageObj.instanceDashboardPage().navigateToPunchhInstance(baseUrl);
		pageObj.instanceDashboardPage().loginToInstance();
		pageObj.instanceDashboardPage().selectBusiness(dataSet.get("slug"));
		...
		Assert.assertEquals(pointsEarnedTotal, points_earned, "points balance is not equal to " + points_earned);
		...
		Assert.assertEquals(pointsSpentTotal, points_spent, "total credits is not equal to 0");
		logger.info("Verified that total credits is not equal to " + points_spent + " for Api V1 checkins");
		utils.logPass("Verified that total credits is not equal to " + points_spent + " for Api V1 checkins");
	...
	@Test(description = "OLF-T2158 [New ML redemption mark is less than old] Verify user balance in different Auth API's when business configuration has membership level Redemption Mark configured [User case 7]")
	public void T2158_VerifyAuthApi() throws Exception {
		// login to instance -> here instance is https://divya.punchh.io
		pageObj.instanceDashboardPage().navigateToPunchhInstance(baseUrl);
		pageObj.instanceDashboardPage().loginToInstance();
		pageObj.instanceDashboardPage().selectBusiness(dataSet.get("slug"));
		...
		Assert.assertEquals(200, fetchAccountBalResponse.getStatusCode(),
		...
		Assert.assertEquals(total_creditsAuthCheckinsBalance, points_earned,
				"total credits is not equal to " + points_earned);
		logger.info(
				"Verified that total credits is not equal to " + points_earned + " for Auth Api Fetch checkin balance");
		utils.logPass(
				"Verified that total credits is not equal to " + points_earned + " for Auth Api Fetch checkin balance");

		int total_debitsAuthCheckinsBalance = Integer
				.parseInt(fetchAccountBalResponse.jsonPath().get("total_debits").toString().replace(".0", ""));
		Assert.assertEquals(total_debitsAuthCheckinsBalance, points_spent, "total debits is not equal to 120");
		logger.info("Verified that total debits is equal to " + points_spent + " for Auth Api Fetch checkin balance");
		utils.logPass("Verified that total debits is equal to " + points_spent + " for Auth Api Fetch checkin balance");
		...
		Assert.assertEquals(banked_rewardsAuthCheckinsBalance, actualPoints,
				"banked_rewards is not equal to " + actualPoints);
		...
		Assert.assertEquals(net_balanceAuthCheckinsBalance, actualPoints,
				"net_balance is not equal to " + actualPoints);
		logger.info("Verified that net_balance is equal to " + actualPoints + " for Auth Api Fetch checkin balance");
		utils.logPass("Verified that net_balance is equal to " + actualPoints + " for Auth Api Fetch checkin balance");

		int net_debitsAuthCheckinsBalance = Integer
				.parseInt(fetchAccountBalResponse.jsonPath().get("net_debits").toString().replace(".0", ""));
		Assert.assertEquals(net_debitsAuthCheckinsBalance, points_spent, "net_debits is not equal to " + points_spent);
		logger.info("Verified that net_debits is equal to " + points_spent + " for Auth Api Fetch checkin balance");
		utils.logPass("Verified that net_debits is equal to " + points_spent + " for Auth Api Fetch checkin balance");

	}

	@Test(description = "OLF-T2159 [New ML redemption mark is less than old] Verify user balance in dashboard API when business configuration has membership level Redemption Mark configured [User case 7]")
	public void T2159_VerifyDashboardApi() throws Exception {
		// login to instance -> here instance is https://divya.punchh.io
		pageObj.instanceDashboardPage().navigateToPunchhInstance(baseUrl);
		pageObj.instanceDashboardPage().loginToInstance();
		pageObj.instanceDashboardPage().selectBusiness(dataSet.get("slug"));
		...
		Assert.assertEquals(total_creditsUsersInfo, points_earned, "total credits is not equal to " + points_earned);
		logger.info("Verified that total credits is not equal to " + points_earned + " for Dashboard user info");
		utils.logPass("Verified that total credits is not equal to " + points_earned + " for Dashboard user info");

		int total_debitsUsersInfo = Integer
				.parseInt(userLookUpApi2.jsonPath().get("balance.total_debits").toString().replace(".0", ""));
		Assert.assertEquals(total_debitsUsersInfo, points_spent, "total debits is not equal to " + points_spent);
		logger.info("Verified that total debits is equal to " + points_spent + " for Dashboard user info");
		utils.logPass("Verified that total debits is equal to " + points_spent + " for Dashboard user info");
		...
		Assert.assertEquals(net_balanceUsersInfo, actualPoints, "net_balance is not equal to " + actualPoints);
		logger.info("Verified that net_balance is equal to " + actualPoints + " for Dashboard user info");
		utils.logPass("Verified that net_balance is equal to " + actualPoints + " for Dashboard user info");

		int net_debitsUsersInfo = Integer
				.parseInt(userLookUpApi2.jsonPath().get("balance.net_debits").toString().replace(".0", ""));
		Assert.assertEquals(net_debitsUsersInfo, points_spent, "net_debits is not equal to " + points_spent);
		logger.info("Verified that net_debits is equal to " + points_spent + " for Dashboard user info");
		utils.logPass("Verified that net_debits is equal to " + points_spent + " for Dashboard user info");

	}

	@Test(description = "OLF-T2160 [New ML redemption mark is less than old] Verify user balance in pos/checkin API when business configuration has membership level Redemption Mark configured [User case 7]")
	public void T2160_VerifyPosApi() throws Exception {
		// login to instance -> here instance is https://divya.punchh.io
		pageObj.instanceDashboardPage().navigateToPunchhInstance(baseUrl);
		pageObj.instanceDashboardPage().loginToInstance();
		pageObj.instanceDashboardPage().selectBusiness(dataSet.get("slug"));
		...
		Assert.assertEquals(pointBalancePosCheckin, actualPoints, "points balance is not equal to " + actualPoints);
		logger.info("Verified that points balance is not equal to " + actualPoints + " for Pos Checkin");
		utils.logPass("Verified that points balance is not equal to " + actualPoints + " for Pos Checkin");

		int totalCreditsPosCheckin = Integer
				.parseInt(checkinResponse.jsonPath().get("balance.total_credits").toString().replace(".0", ""));
		Assert.assertEquals(totalCreditsPosCheckin, points_earned, "total credits is not equal to " + points_earned);
		logger.info("Verified that total credits is not equal to " + points_earned + " for Pos Checkin");
		utils.logPass("Verified that total credits is not equal to " + points_earned + " for Pos Checkin");

		int totalDebitsPosCheckin = Integer
				.parseInt(checkinResponse.jsonPath().get("balance.total_debits").toString().replace(".0", ""));
		Assert.assertEquals(totalDebitsPosCheckin, points_spent, "total debits is not equal to " + points_spent);
		logger.info("Verified that total debits is equal to " + points_spent + " for Pos Checkin");
		utils.logPass("Verified that total debits is equal to " + points_spent + " for Pos Checkin");
		...
		Assert.assertEquals(net_balancePosCheckin, actualPoints, "net_balance is not equal to " + actualPoints);
		logger.info("Verified that net_balance is equal to " + actualPoints + " for Pos Checkin");
		utils.logPass("Verified that net_balance is equal to " + actualPoints + " for Pos Checkin");

		int net_debitsPosCheckin = Integer
				.parseInt(checkinResponse.jsonPath().get("balance.net_debits").toString().replace(".0", ""));
		Assert.assertEquals(net_debitsPosCheckin, points_spent, "net_debits is not equal to " + points_spent);
		logger.info("Verified that net_debits is equal to " + points_spent + " for Pos Checkin");
		utils.logPass("Verified that net_debits is equal to " + points_spent + " for Pos Checkin");

	}

	@Test(description = "OLF-T2161 [[New ML redemption mark is less than old] Verify user details in accounts table when business configuration has membership level Redemption Mark configured [User case 7] || "
			+ "OLF-T2162 [New ML redemption mark is less than old] Verify user details in checkins table when business configuration has membership level Redemption Mark configured [User case 7] || "
			+ "OLF-T2163 [New ML redemption mark is less than old] Verify PointDebits in reward_debits table when business configuration has membership level Redemption Mark configured [User case 7] || "
			+ "OLF-T2164 [New ML redemption mark is less than old] Verify user details in membership_level_histories table when business configuration has membership level Redemption Mark configured [User case 7]")
	public void T2161_VerifyAccountsTable() throws Exception {
		// login to instance -> here instance is https://divya.punchh.io
		pageObj.instanceDashboardPage().navigateToPunchhInstance(baseUrl);
		pageObj.instanceDashboardPage().loginToInstance();
		pageObj.instanceDashboardPage().selectBusiness(dataSet.get("slug"));
		...
		int spentPoint = Integer.parseInt(dataSet.get("redemptionMarkNew"));
		int totalPoints = Integer.parseInt(dataSet.get("amount")) + Integer.parseInt(dataSet.get("amount1"));
		...
		String pointsSpent = DBUtils.executeQueryAndGetColumnValuePollingUsed(env, query4,
				"pointsSpentAmount", 5);
		int points_spent = Integer.parseInt(pointsSpent);
		Assert.assertEquals(points_spent, spentPoint,
				"points_spent column in checkins table is not equal to expected value i.e. " + spentPoint);
		logger.info("points_spent column in checkins table is equal to expected value " + spentPoint);
			utils.logit("total_debits column in checkins table is equal to expected value " + spentPoint);
		...
		Assert.assertEquals(totalDebits, spentPoint,
				"total_debits column in accounts table is not equal to expected value i.e. " + spentPoint);
		logger.info("total_debits column in accounts table is equal to expected value i.e. " + spentPoint);
		utils.logPass("total_debits column in accounts table is equal to expected value i.e. " + spentPoint);
		...
		String expColValue11 = DBUtils.executeQueryAndGetColumnValuePollingUsed(env, query11,
				"previous_membership_level_id", 5); // dbUtils.getValueFromColumn(query2, "membership_level_id");

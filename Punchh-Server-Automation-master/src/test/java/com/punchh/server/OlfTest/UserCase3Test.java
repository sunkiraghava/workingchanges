...
public class UserCase3Test {

	private static Logger logger = LogManager.getLogger(UserCase3Test.class);
	...
	// Rakhi
	@Test(description = "OLF-T2150 [New ML redemption mark is less than old] Verify user details in membership_level_histories table when business configuration has membership level Redemption Mark configured [ User case 3 (59)]")
	public void T2150_VerifyNewMLredemptionMarkLessThanOld() throws Exception {
		...
		logger.info("POS checkin is successful for " + "59" + " dollar");
		utils.logPass("POS checkin is successful for " + "59" + " dollar");
		...
		logger.info("POS checkin is successful for " + "1" + " dollar");
		utils.logPass("POS checkin is successful for " + "1" + " dollar");
	...
	// Rakhi
	@Test(description = "OLF-T2149 [New ML redemption mark is less than old] Verify PointDebits in reward_debits table when business configuration has membership level Redemption Mark configured [ User case 3 (59)]")
	public void T2149_VerifyNewMLredemptionMarkLessThanOld() throws Exception {
	...
	// Rakhi
	@Test(description = "OLF-T2148 [New ML redemption mark is less than old] Verify user details in checkins table when business configuration has membership level Redemption Mark configured [ User case 3 (59)]")
	public void T2148_VerifyNewMLredemptionMarkLessThanOld() throws Exception {
	...
	// Rakhi
	@Test(description = "OLF-T2147 [New ML redemption mark is less than old] Verify user details in accounts table when business configuration has membership level Redemption Mark configured [ User case 3 (59)]")
	public void T2147_VerifyNewMLredemptionMarkLessThanOld() throws Exception {
		...
		String expColValue3 = DBUtils.executeQueryAndGetColumnValuePollingUsed(env, query5,
				"total_debits", 5);
		int expTotalDebit = Integer.parseInt(expColValue3.replace(".00", ""));
		Assert.assertEquals(expTotalDebit, points_spent,
				"total_debits column in accounts table is not equal to expected value i.e. " + expTotalDebit);
		// total_debits for comparison
		logger.info("total_debits column in accounts table is equal to expected value i.e. " + expTotalDebit);
		utils.logPass("total_debits column in accounts table is equal to expected value i.e. " + expTotalDebit);
		...
		String expColValue4 = DBUtils.executeQueryAndGetColumnValuePollingUsed(env, query6,
				"total_credits", 5);
		int expTotalCredit = Integer.parseInt(expColValue4.replace(".0", ""));
		Assert.assertEquals(expTotalCredit, points_earned,
				"total_credits column in accounts table is not equal to expected value i.e. " + expTotalCredit);
		logger.info("total_credits column in accounts table is equal to expected value i.e. " + expTotalCredit);
		utils.logPass("total_credits column in accounts table is equal to expected value i.e. " + expTotalCredit);
	...
	// Rakhi
	@Test(description = "OLF-T2146 [New ML redemption mark is less than old] Verify user balance in pos/checkin API when business configuration has membership level Redemption Mark configured [ User case 3 (59)]")
	public void T2146_VerifyNewMLredemptionMarkLessThanOld() throws Exception {
	...
	// Rakhi
	@Test(description = "OLF-T2145 [New ML redemption mark is less than old] Verify user balance in dashboard API when business configuration has membership level Redemption Mark configured [ User case 3 (59)]")
	public void T2145_VerifyNewMLredemptionMarkLessThanOld() throws Exception {
	...
	// Rakhi
	@Test(description = "OLF-T2144 [New ML redemption mark is less than old] Verify user balance in different Auth API's when business configuration has membership level Redemption Mark configured [ User case 3 (59)]")
	public void T2144_VerifyNewMLredemptionMarkLessThanOld() throws Exception {
	...
	// Rakhi
	@Test(description = "OLF-T2143 [New ML redemption mark is less than old] Verify user balance in different V1 API's when business configuration has membership level Redemption Mark configured [ User case 3 (59)]")
	public void T2143_VerifyNewMLredemptionMarkLessThanOld() throws Exception {
	...
	// Rakhi
	@Test(description = "OLF-T2142 [New ML redemption mark is less than old] Verify user balance in different API2 API's when business configuration has membership level Redemption Mark configured [ User case 3 (59)]")
	public void T2142_VerifyNewMLredemptionMarkLessThanOld() throws Exception {
	...
	// Rakhi
	@Test(description = "OLF-T2141 [New ML redemption mark is less than old] Verify user balance in different secure API's when business configuration has membership level Redemption Mark configured [ User case 3 (59)]")
	public void T2141_VerifyNewMLredemptionMarkLessThanOld() throws Exception {
	...
	// Rakhi
	@Test(description = "OLF-T2140 [New ML redemption mark is less than old] Verify user's account history when business configuration has membership level Redemption Mark configured [ User case 3 (59)]")
	public void T2140_VerifyNewMLredemptionMarkLessThanOld() throws Exception {
	...
	// Rakhi
	@Test(description = "OLF-T2139 [New ML redemption mark is less than old] Verify user's timeline / pie chart when business configuration has membership level Redemption Mark configured [ User case 3 (59)]"
			+ "OLF-T2138 [New ML redemption mark is less than old] Verify user's print timeline when business configuration has membership level Redemption Mark configured [ User case 3 (59)]")
	public void T2139_VerifyNewMLredemptionMarkLessThanOld() throws Exception {
	...
	// Rakhi
	@Test(description = "OLF-T2137 [New ML redemption mark is less than old] Verify point balance in iframe for users when business configuration has membership level Redemption Mark configured [User case 3 ( 59)]")
	public void T2137_VerifyNewMLredemptionMarkLessThanOld() throws Exception {

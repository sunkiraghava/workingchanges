...
public class VerifyLessRedemptionMarkThanPreviousMark {
	private static Logger logger = LogManager.getLogger(VerifyLessRedemptionMarkThanPreviousMark.class);
	...
	public void T1934_VerifyLessRedemptionMarkThanPreviousMark() throws Exception {

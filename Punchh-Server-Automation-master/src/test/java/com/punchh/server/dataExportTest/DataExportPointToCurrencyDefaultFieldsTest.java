...
public class DataExportPointToCurrencyDefaultFieldsTest {
	static Logger logger = LogManager.getLogger(DataExportPointToCurrencyDefaultFieldsTest.class);
	...
	@Test(description = "SQ-T5346 Run All Data Export with all field selected on Point to Currency Business (Objective-1)", groups = "Regression")
	public void T5346_verifyDataExportPointToCurrencyForDefaultFields() throws InterruptedException {
		...
		String exportName = CreateDateTime.getUniqueString("T5346_AutoDataExport_DefaultField");

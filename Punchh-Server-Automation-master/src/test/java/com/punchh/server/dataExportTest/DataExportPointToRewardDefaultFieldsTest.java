...
public class DataExportPointToRewardDefaultFieldsTest {
	static Logger logger = LogManager.getLogger(DataExportPointToRewardDefaultFieldsTest.class);
	...
	@Test(description = "SQ-T5340 Run All Data Export with all field selected on Point to Reward Business (Objective-1)", groups = "Regression")
	public void T5340_verifyDataExportPointToRewardForDefaultFields() throws InterruptedException {
		...
		String exportName = CreateDateTime.getUniqueString("T5340_AutoDataExport_DefaultField");

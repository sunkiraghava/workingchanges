...
public class DataExportPointToRewardSepificFieldsWithSingleLocationTest {
	static Logger logger = LogManager.getLogger(DataExportPointToRewardSepificFieldsWithSingleLocationTest.class);
	...
	@Test(description = "SQ-T5340 Run All Data Export with all field selected on Point to Reward Business (Objective-3)", groups = "Regression", priority = 0)
	public void T5340_verifyDataExportPointToRewardSepificFieldsWithSingleLocation() throws Exception {
		...
		String exportName = CreateDateTime.getUniqueString("T5340_AutoDataExport_SpecificLocation");

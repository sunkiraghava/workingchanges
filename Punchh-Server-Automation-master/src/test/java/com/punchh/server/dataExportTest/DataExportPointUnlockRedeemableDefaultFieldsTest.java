...
public class DataExportPointUnlockRedeemableDefaultFieldsTest {
	static Logger logger = LogManager.getLogger(DataExportPointUnlockRedeemableDefaultFieldsTest.class);
	...
	@Test(description = "SQ-T5342 Run All Data Export with all field selected on Point Unlock Redeemable Business (Objective-1)", groups = "Regression")
	public void T5342_verifyDataExportPointUnlockRedeemableForDefaultFields() throws InterruptedException {
		...
		String exportName = CreateDateTime.getUniqueString("T5342_AutoDataExport_DefaultField");

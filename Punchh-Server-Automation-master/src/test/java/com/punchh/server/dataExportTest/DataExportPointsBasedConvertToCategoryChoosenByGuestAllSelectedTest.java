...
public class DataExportPointsBasedConvertToCategoryChoosenByGuestAllSelectedTest {
	static Logger logger = LogManager
			.getLogger(DataExportPointsBasedConvertToCategoryChoosenByGuestAllSelectedTest.class);
	...
	@Test(description = "SQ-T5343 Run All Data Export with all field selected on Points based convert to category choosen by guest Business (Objective-2)", groups = "Regression")
	public void T5343_verifyDataExportPointsBasedConvertToCategoryChoosenByGuestAllSelectedTest()
		...
		List<String> logList = Arrays.asList("redemption", "user_feedback", "checkin", "checkin_failure", "referral",
				"receipt_item", "locations", "guest", "reward", "archive_rewards", "gift_card", "migrated_guest",
				"guests_awaiting_migration", "campaign", "coupon", "redeemable", "payment", "coupon_redemption",
				"user_subscription", "subscription_discount", "subscription_credit", "subscription_debit");

		logger.info("== Data export validation test ==");
		String exportName = CreateDateTime.getUniqueString("T5343_AutoDataExport_AllFieldSelected");

...
public class DataExportPointsBasedConvertToCategoryChoosenByGuestDefaultFieldsTest {
	static Logger logger = LogManager
			.getLogger(DataExportPointsBasedConvertToCategoryChoosenByGuestDefaultFieldsTest.class);
	...
	@Test(description = "SQ-T5343 Run All Data Export with all field selected on Points based convert to category choosen by guest Business (Objective-1)", groups = "Regression")
	public void T5343_verifyDataExportPointsBasedConvertToCategoryChoosenByGuestForDefaultFields()
		...
		String exportName = CreateDateTime.getUniqueString("T5343_AutoDataExport_DefaultField");

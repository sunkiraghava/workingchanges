...
public class DataExportPointsBasedConvertToCategoryChoosenByGuestSepificFieldsWithSingleLocationTest {
	static Logger logger = LogManager
			.getLogger(DataExportPointsBasedConvertToCategoryChoosenByGuestSepificFieldsWithSingleLocationTest.class);
	...
	@Test(description = "SQ-T5343 Run All Data Export with all field selected on Points based convert to category choosen by guest Business (Objective-3)", groups = "Regression", priority = 0)
	public void T5343_verifyDataExportPointsBasedConvertToCategoryChoosenByGuestSepificFieldsWithSingleLocation()
			throws Exception {
		...
		String exportName = CreateDateTime.getUniqueString("T5343_AutoDataExport_SpecificLocation");

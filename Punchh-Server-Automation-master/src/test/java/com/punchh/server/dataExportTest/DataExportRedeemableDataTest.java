...
public class DataExportRedeemableDataTest {
	static Logger logger = LogManager.getLogger(DataExportRedeemableDataTest.class);
	...
	@Test(description = "SQ-T2694 Verify new Data export being added for Redeemable Data", groups = "Regression", priority = 0)
	public void T2694_verifyRedeemableDataExport() throws InterruptedException {
		...
		String exportName = CreateDateTime.getUniqueString("T2694_AutoDataExport");

...
public class DataExportVisitBasedAllSelectedTest {
	static Logger logger = LogManager.getLogger(DataExportVisitBasedAllSelectedTest.class);
	...
	@Test(description = "SQ-T5344 Run All Data Export with all field selected on Visit Based Business (Objective-2)", groups = "Regression")
	public void T5344_verifyDataExportVisitBasedAllSelectedTest() throws InterruptedException {
		...
		String exportName = CreateDateTime.getUniqueString("T5344_AutoDataExport_AllFieldSelected");

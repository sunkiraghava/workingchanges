...
public class DataExportVisitBasedSepificFieldsWithSingleLocationTest {
	static Logger logger = LogManager.getLogger(DataExportVisitBasedSepificFieldsWithSingleLocationTest.class);
	...
	@Test(description = "SQ-T5344 Run All Data Export with all field selected on Visit Based Business (Objective-3)", groups = "Regression", priority = 0)
	public void T5344_verifyDataExportVisitBasedSepificFieldsWithSingleLocation() throws Exception {
		...
		String exportName = CreateDateTime.getUniqueString("T5344_AutoDataExport_SpecificLocation");

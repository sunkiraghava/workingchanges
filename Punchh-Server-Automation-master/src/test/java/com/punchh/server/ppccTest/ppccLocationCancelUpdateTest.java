 ...
 * @brief This class contains UI test cases for the POS Control Center > Location > Cancel Update functionality.
 * @fileName ppccLocationCancelUpdateTest.java
 */
...
public class ppccLocationCancelUpdateTest {
    static Logger logger = LogManager.getLogger(ppccLocationCancelUpdateTest.class);
    ...
    @Test(description = "SQ-T6186 Verify the flow of cancel update a location" +
            "SQ-T6340 Verify the audit log on performing cancel update the location")
    @Owner(name = "Kalpana")
    public void T6186_verifyTheFlowOfCancelUpdateALocation() throws Exception{
        ...
        Assert.assertEquals(policyStatusBeforeSync, "Updates Cancelled", "Policy Status is not correct on Provisioned Location");
        ...
        Assert.assertEquals(policyStatusAfterSync, "Updates Cancelled", "Policy Status is not correct on Provisioned Location After Sync");
        ...
        pageObj.utils().logPass("E2E flow of Cancel Update a Location is verified successfully");
        ...
        Assert.assertEquals(status, "Updates Cancelled", "Status do not exists in audit logs");
        ...
        Assert.assertEquals(eventType, "Updates Cancelled", "EventType do not exists in audit logs");
        ...
        //verify the audit log display details for Cancel Update Event
        ...
        Assert.assertEquals(statusAuditLogDetails, "Updates Cancelled", "Status is not correct in audit logs display details");
        ...
        Assert.assertEquals(eventTypeTimeAuditLogDetails, "Updates Cancelled", "Event Type is not correct in audit logs display details");

        //verify the audit log display details Change Log for Cancel Update Event
        ...
        Assert.assertEquals(configStatusChangeLog.get("oldValue"), "Pending Update", "Old value Config Status mismatch");
        Assert.assertEquals(configStatusChangeLog.get("newValue"), "Updates Cancelled", "New value Config Status mismatch");

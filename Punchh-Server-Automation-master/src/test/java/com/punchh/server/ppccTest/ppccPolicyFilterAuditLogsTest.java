...
public class ppccPolicyFilterAuditLogsTest {
	...
	String policyName = pageObj.ppccUtilities().createPolicy(token, status);
        ...
        String filterValueXpath = pageObj.utils().getLocatorValue("ppccPolicyAuditLog.filterValue").replace("{filterValue}",
                filterValue);
        String filterOptionXpath = pageObj.utils().getLocatorValue("ppccPolicyAuditLog.filterValue").replace("{filterValue}",
                filterOption);

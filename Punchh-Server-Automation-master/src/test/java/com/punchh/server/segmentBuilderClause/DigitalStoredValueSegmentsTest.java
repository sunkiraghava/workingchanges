...
public class DigitalStoredValueSegmentsTest {
	static Logger logger = LogManager.getLogger(DigitalStoredValueSegmentsTest.class);
	...
	public void betaSegementsDigitalStoredValueTest() throws Exception {
		...
		String prefixString = "DigitalStoredValue";
		int counter = 0;
		for (Object k : keys) {
			String key = (String) k;

...
public class GivenFeedbackTypeSegmentsTest {
	static Logger logger = LogManager.getLogger(GivenFeedbackTypeSegmentsTest.class);
	...
	public void createBetaSegementswithSQLQuery() throws Exception {
		...
		String prefixString = "GivenFeedback";
		// int counter = 0;
		for (Object k : keys) {
			String key = (String) k;

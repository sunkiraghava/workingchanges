...
public class GuestRedeemedSignupCampaignSegmentsTest {
	static Logger logger = LogManager.getLogger(GuestRedeemedSignupCampaignSegmentsTest.class);
	...
	public void SegmentBuilderClausesTest() throws Exception {
		...
		String prefixString = "Guestwhoredeemedasignupcampaign";
		int counter = 0;
		for (Object k : keys) {
			String key = (String) k;
		...
		logger.info(segmentsNames);
		TestListeners.extentTest.get().info("segments Names " + segmentsNames);
		logger.info("Total segments created are :" + segmentsNames.size());
		TestListeners.extentTest.get().info("Total segments created are :" + segmentsNames.size());
		logger.info("Created Segments names are :" + segmentsNames);
		TestListeners.extentTest.get().info("Created Segments names are :" + segmentsNames);

...
public class SavedPaymentSegmentsTest {
	static Logger logger = LogManager.getLogger(SavedPaymentSegmentsTest.class);
	...
	public void betaSegementsSavedPaymentTest() throws Exception {
		...
		String prefixString = "SavedPayment";
		// int counter = 0;
		for (Object k : keys) {
			String key = (String) k;

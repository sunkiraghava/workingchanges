...
public class SegmenBetaQueryGuestTargetedFromCampaignTest {
	static Logger logger = LogManager.getLogger(SegmenBetaQueryGuestTargetedFromCampaignTest.class);
	...
	public void SegmentBuilderClausesTest() throws Exception {
		...
		String prefixString = "guestTargetedFromCampaign";
		int counter = 0;
		for (Object k : keys) {
			String key = (String) k;

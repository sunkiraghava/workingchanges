...
public class SegmenBetaQueryRewardTest {
	static Logger logger = LogManager.getLogger(SegmenBetaQueryRewardTest.class);
	...
	@Test(description = "Create beta segements with SQL query and validate their count in ui", dataProvider = "TestDataProvider")
	public void createBetaSegementswithSQLQueryForSegments(String prefixString) throws Exception {
...
//				pageObj.newSegmentHomePage().clickOnSwitchToClassicBtn();
	...
	public Object[][] testDataProvider() {
		...
		return new Object[][] {
				...
				{ "reward" }, { "hasBeenReferred" }, { "has_referred_someone" }, { "gift_card_payment" },
				{ "no_checkin_no_redemption" }, { "subscriptionsubscription_plan" },

				{ "subscriptionsubscription_status" }, { "subscriptionSubscriptionSaving" }

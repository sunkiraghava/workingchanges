...
public class SegmenBetaQuerySpendRankingTest {
	static Logger logger = LogManager.getLogger(SegmenBetaQuerySpendRankingTest.class);
	...
	public void createBetaSegementswithSQLQuery_SpendRanking() throws Exception {
		...
		String prefixString = "SpendRanking";
		int counter = 0;
		for (Object k : keys) {
			String key = (String) k;

...
public class SegmenBetaQueryTotalLifetimeEarnedPointsExcludingExpiredTest {
	static Logger logger = LogManager.getLogger(SegmenBetaQueryTotalLifetimeEarnedPointsExcludingExpiredTest.class);
	...
	public void SegmentBuilderClausesTest() throws Exception {
		...
		String prefixString = "totalLifetimeEarnedPointsExcludingExpired";
		int counter = 0;
		for (Object k : keys) {
			String key = (String) k;

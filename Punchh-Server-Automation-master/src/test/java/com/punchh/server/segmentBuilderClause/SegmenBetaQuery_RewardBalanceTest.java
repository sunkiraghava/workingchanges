...
public class SegmenBetaQuery_RewardBalanceTest {
	static Logger logger = LogManager.getLogger(SegmenBetaQuery_RewardBalanceTest.class);
	...
	public void betaSegementsRewardBalanceTest() throws Exception {
		...
		String prefixString = "rewardBalance";
		int counter = 0;
		for (Object k : keys) {
			String key = (String) k;

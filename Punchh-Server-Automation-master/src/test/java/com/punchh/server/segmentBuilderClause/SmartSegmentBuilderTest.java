...
public class SmartSegmentBuilderTest {
	static Logger logger = LogManager.getLogger(SmartSegmentBuilderTest.class);
	...
	public void betaSegementsSmartSegmentTest() throws Exception {
		...
		String prefixString = "SmartSegment";
		// int counter = 0;
		for (Object k : keys) {
			String key = (String) k;

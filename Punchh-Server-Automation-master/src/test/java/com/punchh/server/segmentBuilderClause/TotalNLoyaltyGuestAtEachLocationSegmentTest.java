...
public class TotalNLoyaltyGuestAtEachLocationSegmentTest {
	static Logger logger = LogManager.getLogger(TotalNLoyaltyGuestAtEachLocationSegmentTest.class);
	...
	public void SegmentBuilderClausesTest() throws Exception {
		...
		String prefixString = "top_n_loyalty_guests_at_each_location";
		int counter = 0;
		for (Object k : keys) {
			String key = (String) k;

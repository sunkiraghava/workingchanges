...
public class TotalRedemptionSegmentsTest {
	static Logger logger = LogManager.getLogger(TotalRedemptionSegmentsTest.class);
	...
	public void SegmentBuilderClausesTest() throws Exception {
		...
		String prefixString = "TotalRedemption";
		int counter = 0;
		for (Object k : keys) {
			String key = (String) k;
...
//				pageObj.newSegmentHomePage().clickOnSwitchToClassicBtn();
	...
	public void SegmentBuilderClausesTestPartTwo() throws Exception {
		...
		List<String> segmentQueryList = new ArrayList<String>();
		Set<Object> keys = prop.keySet();
		String prefixString = "PartTwoTotalRedemption";
		int counter = 0;
		for (Object k : keys) {
			String key = (String) k;

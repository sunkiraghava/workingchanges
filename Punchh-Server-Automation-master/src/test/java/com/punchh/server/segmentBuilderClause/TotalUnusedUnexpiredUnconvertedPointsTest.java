...
public class TotalUnusedUnexpiredUnconvertedPointsTest {
	static Logger logger = LogManager.getLogger(TotalUnusedUnexpiredUnconvertedPointsTest.class);
	...
	public void betaSegmentsTotalUnusedUnexpiredUnconvertedPointsTest() throws Exception {
		...
		String prefixString = "TotalUnusedUnexpiredUnconvertedPoints";
		int counter = 0;
		for (Object k : keys) {
			String key = (String) k;
